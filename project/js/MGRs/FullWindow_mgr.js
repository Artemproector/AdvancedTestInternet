function showWindow(title = '', content = '', autoclose = false) {
    ...
    setTimeout(function () {
        ...
        windowWrapper.innerHTML = `<div class="top-block">
            <h2 class="labal-full-menu">${title}</h2>
            <div class="close" onclick="closeWindow()"><svg xmlns="http://www.w3.org/2000/svg" height="40px"
...
function closeWindow() {
    let fullscreen_window = document.querySelector('.fullscreen-window');
    let windowWrapper = document.querySelector('.fullscreen__wrapper');
    windowWrapper.innerHTML = `            <div class="loader_wrapper">
                <span class="loader"></span>
            </div>`
    fullscreen_window.classList.remove('fullscreen-window--show')//ПОТОМ АНИМАЦИЯ!
